...
func getPositionMutationsForSequence(mutationSet MutationSet) map[int]map[string]string {
	...
	positionMutations = extractPositionSubstitions(convertMutationsStringToArray(mutationSet.Substitutions), positionMutations)
...
func extractPositionSubstitions(substitutions []string, positionMutations map[int]map[string]string) map[int]map[string]string {
